...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath}/appinfolist">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="queryStatus" class="form-control">
									   ...
									   <c:forEach var="dataDictionary" items="${listData}">
				...
				<div class="row">
					...
					<a href="${pageContext.request.contextPath}/appinfoadd" class="btn btn-success btn-sm">新增APP基础信息</a>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li>
							<a class="saleSwichOpen" saleSwitch="open" appinfoid="${appInfo.id }" status="${appInfo.status}"  appsoftwarename="${appInfo.softwareName }"  data-toggle="tooltip" data-placement="top" title="" data-original-title="恭喜您，您的审核已经通过，您可以点击上架发布您的APP">上架</a>
							<a class="saleSwichClose" saleSwitch="close" appinfoid="${appInfo.id }" status="${appInfo.status}"  appsoftwarename="${appInfo.softwareName }" data-toggle="tooltip" data-placement="top" title="" data-original-title="您可以点击下架来停止发布您的APP，市场将不提供APP的下载">下架</a>
                        </li>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							role="status" aria-live="polite">共${P.pretionSum}条记录
							${P.pretionCount }/${P.pretionCoulltion }页</div>
					</div>
					<div class="col-sm-7">
						<div class="dataTables_paginate paging_simple_numbers"
							...
							<ul class="pagination">
									...
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${P.pretionCount-1});"
									...
									<li class="paginate_button next"><a
										href="javascript:page_nav(document.forms[0],${P.pretionCoulltion });"
